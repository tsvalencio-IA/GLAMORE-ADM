...
const required = ["index.html","vercel.json","database.rules.json","database.rules.original.json","js/app.js","js/repository.js","js/calculator.js","js/firebase.js","js/pdf-importer.js","css/app.css","LEIA-ANTES-DE-PUBLICAR.md"];
